# RED Tool 使用指南（v20.7 完整版）

> 版本：v20.7.x · 更新日期：2026-05-06
> 涵盖：引擎规范、封装方案、Figma 插件集成、Python 端实现
>
...
> components 防御过滤、Figma 端 code.js 三处 bug 修复（visible/fill/单 variant 尺寸）。
